...
<NavbarMaines/>
  ...
  <div  id="section1" v-if="!es">
<NavbarMain :shift="shifting" @switching="switcher" />
</div>
...
import B1DetailsES from '../views/B1DetailsES.vue'
// import { save } from vue;
export default {
  name:'Welcome',
  // emits :['switching'],

components : { SignupForm, LoginForm , NavbarMain , Bevents, BakkanoEvents, NavbarMaines, B1DetailsES ,Chat },
setup() {
//   const dont =ref(false)
// const idd = ref('b78dyTrFsSw8NH4X7tF9')

   const shifting =ref(true)
...
watch(shifting ,()=> {
  ...
  console.log('logging',shifting.value)
  


const eve = ref(' WE LOVE  EVENTS ')
const eve2 = ref(false)
...
enIcon.value =! enIcon.value
  ...
  return { ShowLogin , enterChat , eve ,eve2 , es , esp , enIcon ,eng ,hideAll ,shifting  , switcher}
...
#section1{ width:auto ;height:auto;max-height:500%;display:block;position: relative;margin-bottom: 40px;}
#section2{transition: all 1 ease; display:block;position: relative;margin: 20px 0px 20% 0px !important;top:0px;}
