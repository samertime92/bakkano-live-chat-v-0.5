...
<div class="navbar">
      <nav>
          ...
          <h4><router-link class="links3" :to="{ name: ''}">Comunidad</router-link></h4>
...
<div  v-for="item in cate.items" :key="item.id">
 ...
 <div v-if="documents">
        ...
        <router-link class="links"  :to="{name:'B1DetailsES', params: {id:doc.id} } ">
...
export default {
props:['id'],
components:{AddItems, Bakkano1menuES },
setup(props,context){
