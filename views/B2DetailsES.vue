...
<div  v-for="item in cate.items" :key="item.id">
 ...
 <div v-if="documents">
        ...
        <router-link class="links"  :to="{name:'Mirrorb2ES', params: {id:doc.id} } ">
...
h4{color:white ; display:inline-block;background-color:black;border-radius:20px; box-shadow: 2px 10px 10px rgba(85, 83, 83,0.350)}
